...
import {
  ApproveInventoryReceivingVoucher,
  GetInventoryReceivingVoucherByIDAPI,
  RejectInventoryReceivingVoucher,
} from '../../../../../../Api/Home/StableWarehouseAPI/StableWarehouseAPI';
import UsersAPI from '../../../../../../Api/Home/UsersAPI/UsersAPI';
const DetailInventoryReceivingVoucher = props => {
      ...
      {edit && (
        <View style={styles.viewModal}>
          <CustomConfirm
            ...
            content={'Bạn có muốn sửa phiếu nhập kho ?'}
            leftLabel={'Trở lại'}
            rightLabel={'Sửa'}
            leftPress={() => setEdit(false)}
            rightPress={() => {
              let id = result?.id;
              navigation.navigate('UpdateInventoryReceivingVoucher', id);
              setEdit(false);
            }}
          />
        </View>
...
export default DetailInventoryReceivingVoucher;
