...
import {GetInventoryDeliveryVoucherAPI} from '../../../../../Api/Home/StableWarehouseAPI/StableWarehouseAPI';

const ListInventoryDeliveryVoucher = props => {
  ...
  const getlistVoucherAPI = async () => {
    await GetInventoryDeliveryVoucherAPI(token)
      .then(res => {
  ...
  const renderItem = (item, index) => {
    return (
      <TouchableOpacity
        ...
        onPress={() => {
          let id = item?.id;
          navigation.navigate('DetalInventoryDeliveryVoucher', id);
        }}>
                ...
                {userInfor?.role != 'EMPLOYEE' && (
                  <View style={{alignItems: 'center'}}>
                    ...
                    <CustomButtonIcon
                      ...
                      onPress={() =>
                        navigation.navigate('CreateAInventoryDeliveryVoucher')
                      }
                    />
                  </View>
                )}
...
export default ListInventoryDeliveryVoucher;
