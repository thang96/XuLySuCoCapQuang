...
import {GetInventoryControlVoucherAPI} from '../../../../../Api/Home/StableWarehouseAPI/StableWarehouseAPI';

const ListInventoryControlVoucher = props => {
  ...
  const getlistVoucherAPI = async () => {
    await GetInventoryControlVoucherAPI(token)
      .then(res => {
  ...
  const renderItem = (item, index) => {
    return (
      <TouchableOpacity
        ...
        onPress={() => {
          let id = item?.id;
          navigation.navigate('DetailInventoryControlVoucher', id);
        }}>
                ...
                {userInfor?.role != 'EMPLOYEE' && (
                  <View style={{alignItems: 'center'}}>
                    ...
                    <CustomButtonIcon
                      ...
                      onPress={() =>
                        navigation.navigate('CreateInventoryControlVoucher')
                      }
                    />
                  </View>
                )}
...
export default ListInventoryControlVoucher;
